...
// Абсолютные скорости взяты из оригинала после того, как выяснилось, что единица
// движка Getting Up — ДЮЙМ (у IScreenShake дизайнеры подписали "Magnitude (in)",
// "Radius (ft)"). Пересчёт метрики BNM при 30 к/с:
//   TR_Walk 90.91 дюйма за 59 кадров = 2.31 м за 1.97 с = 1.17 м/с
//   TR_Run 206.46 дюйма за 47 кадров = 5.24 м за 1.57 с = 3.35 м/с
// Это нормальные человеческие скорости (ходьба 1.2-1.4, трусца ~3.3), что и
// подтверждает трактовку. Прежние 1.61/4.60 сохраняли верное отношение 2.85x,
